...
function doGet(e) {
  if (!isAuthorizedRequest_(e)) {
    return HtmlService.createHtmlOutput(
      ...
      "<body style=\"font-family:system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;margin:0;min-height:100vh;display:grid;place-items:center;background:#f3f1e8;color:#17201f;\">" +
      "<main style=\"max-width:520px;padding:24px;text-align:center;\"><h1 style=\"margin:0 0 8px;font-size:28px;\">TrackerPal is locked</h1><p style=\"margin:0;color:#66716f;line-height:1.5;\">Open TrackerPal from the desktop shortcut on this computer.</p></main>" +
      "</body></html>"
